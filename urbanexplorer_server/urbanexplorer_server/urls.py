...
from api.resources import UserProfileResource, UserResource, SessionResource, ProgressResource, StageResource, MissionResource, RouteResource, RoutesCompletedResource, AchievementResource, UserAchievementResource, RouteProgressResource
admin.autodiscover()

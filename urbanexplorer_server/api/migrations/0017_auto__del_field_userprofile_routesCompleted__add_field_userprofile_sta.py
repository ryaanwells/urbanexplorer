...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UserProfile.routesCompleted'
        db.delete_column(u'api_userprofile', 'routesCompleted')

        # Adding field 'UserProfile.stagesCompleted'
        db.add_column(u'api_userprofile', 'stagesCompleted',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'UserProfile.routesCompleted'
        db.add_column(u'api_userprofile', 'routesCompleted',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'UserProfile.stagesCompleted'
        db.delete_column(u'api_userprofile', 'stagesCompleted')
    ...
    models = {
        u'api.achievement': {
            ...
            'metric': ('django.db.models.fields.FloatField', [], {'default': '0'}),
        ...
        u'api.route': {
            ...
            'lockedBy': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'to': u"orm['api.Route']"}),
            'mission': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['api.Mission']"}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
            'nextRoute': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'to': u"orm['api.Route']"}),
        ...
        u'api.session': {
            ...
            'routesCompleted': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['api.RoutesCompleted']", 'null': 'True', 'blank': 'True'}),
            'routesDone': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
        ...
        u'api.userprofile': {
            ...
            'stagesCompleted': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),

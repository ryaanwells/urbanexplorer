...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Route.nextRoute'
        db.add_column(u'api_route', 'nextRoute',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['api.Route']),
                      keep_default=False)

        # Adding field 'Route.lockedBy'
        db.add_column(u'api_route', 'lockedBy',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['api.Route']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Route.nextRoute'
        db.delete_column(u'api_route', 'nextRoute_id')

        # Deleting field 'Route.lockedBy'
        db.delete_column(u'api_route', 'lockedBy_id')

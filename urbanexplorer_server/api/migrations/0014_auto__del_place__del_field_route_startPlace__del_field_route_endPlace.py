...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Route.startPlace'
        db.delete_column(u'api_route', 'startPlace_id')

        # Deleting field 'Route.endPlace'
        db.delete_column(u'api_route', 'endPlace_id')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Route.startPlace'
        db.add_column(u'api_route', 'startPlace',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='+', to=orm['api.Place']),
                      keep_default=False)

        # Adding field 'Route.endPlace'
        db.add_column(u'api_route', 'endPlace',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='+', to=orm['api.Place']),
                      keep_default=False)

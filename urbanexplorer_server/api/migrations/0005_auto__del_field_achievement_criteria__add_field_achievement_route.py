...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Achievement.criteria'
        db.delete_column(u'api_achievement', 'criteria')

        # Adding field 'Achievement.route'
        db.add_column(u'api_achievement', 'route',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['api.Route'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Achievement.criteria'
        db.add_column(u'api_achievement', 'criteria',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=512),
                      keep_default=False)

        # Deleting field 'Achievement.route'
        db.delete_column(u'api_achievement', 'route_id')

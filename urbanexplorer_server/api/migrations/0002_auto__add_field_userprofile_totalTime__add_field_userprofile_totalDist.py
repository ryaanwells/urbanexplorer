...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.totalTime'
        db.add_column(u'api_userprofile', 'totalTime',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'UserProfile.totalDistance'
        db.add_column(u'api_userprofile', 'totalDistance',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.totalTime'
        db.delete_column(u'api_userprofile', 'totalTime')

        # Deleting field 'UserProfile.totalDistance'
        db.delete_column(u'api_userprofile', 'totalDistance')

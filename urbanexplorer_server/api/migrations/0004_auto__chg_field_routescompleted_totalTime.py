...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RoutesCompleted.totalTime'
        db.alter_column(u'api_routescompleted', 'totalTime', self.gf('django.db.models.fields.PositiveIntegerField')())

    def backwards(self, orm):

        # Changing field 'RoutesCompleted.totalTime'
        db.alter_column(u'api_routescompleted', 'totalTime', self.gf('django.db.models.fields.TimeField')(null=True))
